...
namespace Pathfinding.Util
{
  public static class MovementUtilities
  {
    ...
    public static Vector2 CalculateAccelerationToReachPoint(Vector2 deltaPosition, Vector2 targetVelocity,
      Vector2 currentVelocity, float forwardsAcceleration, float rotationSpeed, float maxSpeed, Vector2 forwardsVector)
    {
      ...
      else
      {
        ...
        var targetPoint = deltaPosition - normalizedTargetVelocity * System.Math.Min(
        ...
        var finalAcceleration =
          (targetPoint.normalized * maxSpeed - currentVelocity) * (1f / TimeToReachDesiredVelocity);
