  ...
  public static class EditorResourceHelper
  {
    ...
    public static Material GizmoSurfaceMaterial
    {
      get
      {
        if (!surfaceMat)
          surfaceMat =
            UnityEditor.AssetDatabase.LoadAssetAtPath(EditorResourceHelper.editorAssets + "/Materials/Navmesh.mat",
      ...
      get
      {
        if (!lineMat)
          lineMat = UnityEditor.AssetDatabase.LoadAssetAtPath(
            EditorResourceHelper.editorAssets + "/Materials/NavmeshOutline.mat", typeof(Material)) as Material;
        return lineMat;
      }
    }
