  ...
  public static class GraphUtilities
  {
      ...
      GridNodeBase[] nodes = null)
    {
      ...
      var neighbourIndices =
        grid.neighbours == NumNeighbours.Six ? GridGraph.hexagonNeighbourIndices : new[] {0, 1, 2, 3};
                  ...
                  !seenStates.Contains(startState))
              {
                ...
                while (true)
                {
                  ...
                  if (neighbour == null || (nodeSet != null && !nodeSet.Contains(neighbour)))
                  {
                    ...
                    Vector3 graphSpacePos =
                      new Vector3(node.XCoordinateInGrid + 0.5f, 0, node.ZCoordinateInGrid + 0.5f);
