  ...
  public partial class AIPath : AIBase, IAstarAI
  {
      ...
      out Quaternion nextRotation)
    {
      ...
      if (interpolator.valid && !isStopped)
      {
        ...
        {
          velocity2D += MovementUtilities.CalculateAccelerationToReachPoint(dir, dir.normalized * maxSpeed, velocity2D,
            currentAcceleration, rotationSpeed, maxSpeed, forwards) * deltaTime;
        }
      }
      else
      {
